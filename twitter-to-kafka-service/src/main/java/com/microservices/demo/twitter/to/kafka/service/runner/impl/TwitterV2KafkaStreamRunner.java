...
public class TwitterV2KafkaStreamRunner implements StreamRunner {
    ...
    start() {
        ...
        if (null != bearerToken) {
            ...
            LOG.error("There was a problem getting your bear token. ");
            throw new RuntimeException("There was a problem getting your bear token. " +
                    "Please make sur you set the TWITTER_BEARER_TOKEN environment variable");
        }
